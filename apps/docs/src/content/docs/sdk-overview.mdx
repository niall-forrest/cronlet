...
## Why wrap the SDK instead of calling it everywhere
...
- lets your agent layer call product-specific functions instead of raw task primitives
...
- it does **not** parse natural-language schedules into schedule objects
...
You need to build those product-side pieces yourself.
