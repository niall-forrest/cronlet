...
Use the SDK helper to verify the raw request body before you parse it:
...
Callback signing is now part of the default Cloud flow. You should still:

- validate the signed request before parsing JSON
